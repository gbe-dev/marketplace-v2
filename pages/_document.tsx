...
class MyDocument extends Document {
  ...
  render() {
    const description = 'Fellowship champions the future of photography. We present a new way to discover, collect and learn about photography by exhibiting NFTs from marquee estates, living artists and emerging talent.'
